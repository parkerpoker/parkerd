...
import (
	...
	"github.com/danieldresner/arkade_fun/internal/parker/settlementcore"
	walletpkg "github.com/danieldresner/arkade_fun/internal/parker/wallet"
)
...
func newNativeRuntime(profileName string, config RuntimeConfig, mode string) *nativeRuntime {
	if mode == "" {
		mode = "player"
	}
	return &nativeRuntime{
		...
		store:        newNativeStore(profileName, config),
